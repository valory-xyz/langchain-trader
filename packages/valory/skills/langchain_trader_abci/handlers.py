...
"""This module contains the handlers for the skill of LangchainTraderAbciApp."""
...
from packages.valory.skills.langchain_trader_abci.dialogues import (
    HttpDialogue,
    HttpDialogues,
)
from packages.valory.skills.langchain_trader_abci.models import SharedState
from packages.valory.skills.langchain_trader_abci.rounds import SynchronizedData
...
class HttpHandler(BaseHttpHandler):
    ...
    HANDLER_NAME = "Langchain trader HttpHandler"
