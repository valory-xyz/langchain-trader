...
"""This module contains the shared state for the abci skill of LangchainTraderChainedSkillAbciApp."""
...
class SharedState(BaseSharedState):
    ...
    abci_app_cls = LangchainTraderChainedSkillAbciApp

    def setup(self) -> None:
        """Set up."""
        super().setup()

        LangchainTraderChainedSkillAbciApp.event_to_timeout[
        ...
        LangchainTraderChainedSkillAbciApp.event_to_timeout[
            LangchainTraderEvent.ROUND_TIMEOUT
        ] = (self.context.params.round_timeout_seconds * MULTIPLIER)


class Params(
    LangchainTraderParams,
    MechInteractParams,
    TerminationParams,
):
